...
export default function GoldPill({
  ...
  return (
    <Tag
      ...
      className={`relative inline-flex items-center gap-1.5 rounded-full px-3 py-2 text-[12px] font-extrabold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-amber-400 ${className}`}
      style={{
        background: dim
          ? "rgba(148,163,184,.15)"
